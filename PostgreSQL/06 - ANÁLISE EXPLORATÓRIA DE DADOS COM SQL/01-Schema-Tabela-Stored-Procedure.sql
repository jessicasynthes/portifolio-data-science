...
CREATE SCHEMA schema6 AUTHORIZATION bancodedados;


-- Criação da tabela
CREATE TABLE schema6.lancamentosdsacontabeis (
    id INT PRIMARY KEY,
...
CREATE OR REPLACE PROCEDURE schema6.carregar_dados_contabeis()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT;
...
BEGIN
    FOR i IN 1..1000 LOOP
        ...
        INSERT INTO schema6.lancamentosdsacontabeis (
            id, 
            data_lancamento, 
            conta_debito, 
            conta_credito, 
...
-- Executa a SP
call schema6.carregar_dados_contabeis();
