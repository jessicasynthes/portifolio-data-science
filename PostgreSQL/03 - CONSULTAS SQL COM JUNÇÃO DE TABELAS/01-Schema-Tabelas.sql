...
CREATE SCHEMA schema3 AUTHORIZATION bancodedados;


-- Criação da tabela Clientes
CREATE TABLE schema3.clientes (
...
CREATE TABLE schema3.pedidos (
    id_pedido SERIAL PRIMARY KEY,
    id_produto INT NOT NULL,
    id_cliente INT NOT NULL,
    quantidade INT NOT NULL CHECK (quantidade > 0),
    data_pedido DATE NOT NULL,
    FOREIGN KEY (id_cliente) REFERENCES schema3.clientes(id_cliente),
    FOREIGN KEY (id_produto) REFERENCES schema3.produtos(id_produto)
);


-- Criação da tabela Pedidos sem Integridade Referencial
CREATE TABLE schema3.pedidos_sem_ir (
    id_pedido SERIAL PRIMARY KEY,
    id_produto INT,
    id_cliente INT,
    quantidade INT NOT NULL CHECK (quantidade > 0),
...
INSERT INTO schema3.clientes (nome, sobrenome, estado, tipo) VALUES
...
INSERT INTO schema3.produtos (nome, categoria, preco) VALUES
...
INSERT INTO schema3.pedidos (id_produto, id_cliente, quantidade, data_pedido) VALUES
(1, 1, 20, '2023-10-01'),
(1, 2, 12, '2023-10-02'),
(3, 2, 15, '2023-10-03'),
(4, 4, 44, '2023-10-04'),
...
INSERT INTO schema3.pedidos_sem_ir (id_produto, id_cliente, quantidade, data_pedido) VALUES
(1, 1, 20, '2023-10-01'),
(1, 2, 12, '2023-10-02'),
