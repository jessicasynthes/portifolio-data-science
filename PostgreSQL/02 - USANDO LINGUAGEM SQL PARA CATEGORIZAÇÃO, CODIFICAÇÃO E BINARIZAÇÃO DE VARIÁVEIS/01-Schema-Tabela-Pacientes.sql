...
CREATE SCHEMA schema2 AUTHORIZATION bancodedados;


-- Cria a tabela
CREATE TABLE schema2.pacientes (
    classe VARCHAR(255),
    idade VARCHAR(255),
...
INSERT INTO schema2.pacientes (classe, idade, menopausa, tamanho_tumor, inv_nodes, node_caps, deg_malig, seio, quadrante, irradiando) VALUES
