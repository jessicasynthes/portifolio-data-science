...
CREATE SCHEMA schema4 AUTHORIZATION bancodedados;


-- Criação da tabela Clientes
CREATE TABLE IF NOT EXISTS schema4.clientes (
...
CREATE TABLE IF NOT EXISTS schema4.produtos (
...
CREATE TABLE IF NOT EXISTS schema4.pedidos (
    id_pedido INT PRIMARY KEY,
    id_produto INT REFERENCES schema4.produtos(id_prod),
    data_pedido DATE NULL,
    valor_pedido DECIMAL(10, 2) NULL,
    id_cliente INT REFERENCES schema4.clientes(id_cli)
);
...
INSERT INTO schema4.produtos (id_prod, nome_produto, nome_formacao) 
...
INSERT INTO schema4.pedidos (id_pedido, id_produto, data_pedido, valor_pedido, id_cliente) 
