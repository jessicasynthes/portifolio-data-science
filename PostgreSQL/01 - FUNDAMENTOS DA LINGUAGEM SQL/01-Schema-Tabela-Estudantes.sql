...
CREATE SCHEMA schema1 AUTHORIZATION bancodedados;


-- Criando a tabela 'estudantes'
CREATE TABLE schema1.estudantes (
...
INSERT INTO schema1.estudantes (nome, sobrenome, nota_exame1, nota_exame2, tipo_sistema_operacional) VALUES
