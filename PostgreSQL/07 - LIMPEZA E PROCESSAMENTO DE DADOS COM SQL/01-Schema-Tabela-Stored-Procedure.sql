...
CREATE SCHEMA schema7 AUTHORIZATION bancodedados;


-- Criação da tabela
CREATE TABLE schema7.campanha_marketing (
    id SERIAL,
...
CREATE OR REPLACE PROCEDURE schema7.inserir_dados_campanha()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT := 1;
...
BEGIN
    LOOP
        ...
        -- Inserir registro
        INSERT INTO schema7.campanha_marketing 
...
-- Executa a SP
call schema7.inserir_dados_campanha();
